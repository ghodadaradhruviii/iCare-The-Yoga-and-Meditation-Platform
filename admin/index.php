    ...
    <div class="wrapper">
        <aside id="sidebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a href="?page=appointment" class="sidebar-link navlink" data-page="appointment.php"><i class="lni lni-support"></i>
            ...
            <div class="sidebar-footer">
                <a href="../Login/logout.php" class="sidebar-link"><i class="lni lni-exit"></i>
                    <span>Logout</span></a>
            </div>
        </aside>
